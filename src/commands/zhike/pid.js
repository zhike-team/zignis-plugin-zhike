...
exports.handler = function (argv) {
  ...
  co(function*() {
    ...
    const { Crm2PidMap, CrmDataImportInterface, Crm2MarketActivity, BindHmsr, BindHmpl, BindHmmd, BindHmkw, BindSite } = crmDb.models
    ...
    if (argv.pid.length === 8) {
      ...
      outputTable.push(keys.map(function(field) {
        return pid[field]
      }))
